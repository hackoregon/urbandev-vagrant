...
# Data Book for Table: census\_households\_by\_income
...
The [code book](https://github.com/hackoregon/urbandev-etl/tree/master/postgresql/doc/codebooks/census_households_by_income-codebook-NHGIS.txt), which explains the meaning of each of the fields, was obtained with the data from the National Historical Geographic Information System ([NHGIS](https://www.nhgis.org/)).
...
then found the table named: "Households by Income* in Previous Year [4]" for 1970, 1980, 1990, 2000, 2008-2012 at the tract level. We downloaded that table as a single CSV file.
